...
def create_circular_mask(h, w, center=None, radius=15):
...
mask = create_circular_mask(64, 64)
...
def data_preprocess(data, psf_pl, c_ratio, no_blend):
    ...
    for i in range(len(data)):
        new_img, loc_map = inject_planet(
            data[i].reshape(64, 64), psf_pl, c_ratio=c_ratio, no_blend=True
        )
